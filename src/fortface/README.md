# Este documento trata com detalhes a implementação do componente da Fortface no exemplo em React relacionado ao Liveness 3D.
...
- [Liveness 3D Fortface](https://github.com/oititec/liveness-react-example/blob/main/src/fortface/README.md)
